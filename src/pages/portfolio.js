...
export default function Portfolio() {
  const projects = [
    ...
    {
      description: "community-based pet services",
    ...
    <Container fluid>
      <Row>
        ...
        <div className="projectTitle">
          ...
          <h5>
            Here are some of the projects I have worked on recently, for more
            just &nbsp;
      ...
      <Row style={{ height: `250px`, backgroundColor:'white', marginTop: `-8rem` }}></Row>
      <Footer />
    </Container>
  );
}
